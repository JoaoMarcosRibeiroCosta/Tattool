 ...
 * @author usuario
 */
public class ConsultaTatuadorView extends javax.swing.JFrame {
    TatuadorController controller = new TatuadorController();
    private TatuadorSelecionadoListener listener;
    /**
     * Creates new form ConsultaTatuadorView
     */
    public ConsultaTatuadorView(TatuadorSelecionadoListener listener) {
        initComponents();
    ...
    private void initComponents() {
        ...
        ComboFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nome", "CPF", " " }));
        ...
        LbTituto.setText("Consulta de Tatuador");
...
//
    ...
    private void BtSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtSelecionarActionPerformed
        ...
        if (linha >= 0) {
            ...
            Tatuador tatuador = controller.buscarTatuador(id);

            if (listener != null && tatuador != null) {
                listener.onTatuadorSelecionado(tatuador);
            }
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Selecione um tatuador.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaTatuadorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new ConsultaTatuadorView().setVisible(true);
            }
        });
    }
        public void carregarTabela() {
        String pesquisa = "";
        String filtro = " WHERE t.pessoa_id LIKE '%" + pesquisa + "%'";
