 ...
 * @author usuario
 */
public class ConsultaOrcamentoView extends javax.swing.JFrame {
    OrcamentoController controller = new OrcamentoController();
    private OrcamentoSelecionadoListener listener;
    /**
     * Creates new form ConsultaOrcamentoView
     */
    public ConsultaOrcamentoView(OrcamentoSelecionadoListener listener) {
        initComponents();
        carregarTabela();
    ...
    private void initComponents() {
        ...
        LbTituto.setText("Consulta de Orçamentos");
    ...
    private void BtSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtSelecionarActionPerformed
        ...
        if (linha != -1) {
            ...
            Orcamento orcamento = controller.buscarOrcamento(id);

            if (orcamento != null) {
               if (listener != null) {
                   listener.onOrcametoSelecionado(orcamento);
               }
               this.dispose();
            } else {
               JOptionPane.showMessageDialog(this, "Orcamento não encontrada.");
            }
        } else {
           JOptionPane.showMessageDialog(this, "Nenhuma orcamento selecionada.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaOrcamentoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               // new ConsultaOrcamentoView().setVisible(true);
            }
        });
    }
